...
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr="Planar 3 MENT Flow Pendulum" --env-name Pendulum-v0 --batch_size=1024 --policy='Flow' --flow_model='planar' --n_blocks=3 --comet --seed=1 --mean_entropy&
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr="Planar 5 MENT Flow Pendulum" --env-name Pendulum-v0 --batch_size=1024 --policy='Flow' --flow_model='planar' --n_blocks=5 --comet --seed=2 --mean_entropy &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr="Planar 7 MENT Flow Pendulum" --env-name Pendulum-v0 --batch_size=1024 --policy='Flow' --flow_model='planar' --n_blocks=7 --comet --seed=3 --mean_entropy &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr="Planar 9 MENT Flow Pendulum" --env-name Pendulum-v0 --batch_size=1024 --policy='Flow' --flow_model='planar' --n_blocks=9 --comet --seed=4 --mean_entropy&
