...
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=G-S-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=250000 --policy=Gaussian --smol --comet --alpha=0.2 --silent --seed=0 &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=G-S-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=250000 --policy=Gaussian --smol --comet --alpha=0.2 --silent --seed=3 &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=G-S-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=250000 --policy=Gaussian --smol --comet --alpha=0.2 --silent --seed=4 &