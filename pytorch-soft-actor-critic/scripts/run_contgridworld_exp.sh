...
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=E-S-DG-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=200000 --policy=Exponential --smol --comet --dense_goals --silent --seed=0 &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=E-S-DG-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=200000 --policy=Exponential --smol --comet --dense_goals --silent --seed=2 &
COMET_DISABLE_AUTO_LOGGING=1 python main.py --namestr=E-S-DG-CG --make_cont_grid --batch_size=128 --replay_size=100000 --hidden_size=64 --num_steps=200000 --policy=Exponential --smol --comet --dense_goals --silent --seed=4
